  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child:Padding(
        padding: const EdgeInsets.only(top: 25,left: 17,right: 17,bottom:17),
  ...
  Widget _buildDrawer(BuildContext context) {
    ...
    Column(
      ...
      children: [
        ...
        Text(''),
        Text(''),
        Text('Made by : Shashwat , Kartikeya and Shivam',
           style: TextStyle(
          fontSize: 14,
          color: Colors.black,
          fontWeight: FontWeight.bold,
...
class _ImageCarouselCardState extends State<ImageCarouselCard> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => home_special()));
      },
      child: Stack(
        children: [
          Card(
...
class BackGroundTile extends StatelessWidget {
  ...
  final String img;
  final Widget pages;
  const BackGroundTile({required this.text, required this.img,required this.pages});
